...
const UserDashboard = () => {
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        ...
        >
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-xl sm:text-2xl font-bold">Book {selectedVehicle?.name}</h3>
            <button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
              ...
              <div className="mt-4">
                ...
                <p className="text-xl sm:text-2xl font-bold text-blue-600 mt-2">₹{selectedVehicle?.price}/day</p>
              </div>
            </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Navbar */}
      <UserNavbar activeTab={activeTab} setActiveTab={handleTabChange} />
          ...
          <AnimatePresence mode="wait">
            {tabLoading ? (
              ...
              >
                  ...
                  <div className="space-y-6 sm:space-y-8">
                    ...
                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-6 sm:p-8 text-white">
                      ...
                      >
                        ...
                        <p className="text-blue-100 text-sm sm:text-base">Ready for your next adventure? Let's plan your perfect trip.</p>
                      </motion.div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                      {[
                        ...
                        <motion.div
                          ...
                          className="bg-white p-4 sm:p-6 rounded-xl shadow-sm border hover:shadow-md transition-shadow duration-200"
                        >
                          <div className="flex flex-col sm:flex-row sm:items-center">
                            <div className={`p-2 sm:p-3 bg-${stat.color}-100 rounded-lg mb-2 sm:mb-0 self-start`}>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border">
                      <div className="p-4 sm:p-6 border-b">
                        <h3 className="text-lg sm:text-xl font-semibold">Current Bookings</h3>
                      </div>
                      <div className="p-4 sm:p-6 space-y-4">
                        {currentBookings.map((booking) => (
                          <motion.div
                            ...
                            initial={{ opacity: 0, x: -20 }}
                            animate={{ opacity: 1, x: 0 }}
                            className="flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow duration-200"
                          >
                            <img
                              src={booking.image}
                            ...
                            <div className="flex-1">
                              <h4 className="font-semibold text-sm sm:text-base">{booking.vehicleName}</h4>
                            ...
                            <div className="flex sm:flex-col items-center sm:items-end justify-between sm:justify-center text-right">
                              ...
                              <p className="text-lg font-bold text-gray-900 mt-0 sm:mt-1">₹{booking.amount}</p>
                            </div>
                          </motion.div>
                        ))}
                      </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border">
                      <div className="p-4 sm:p-6 border-b">
                        <h3 className="text-lg sm:text-xl font-semibold">Suggested for You</h3>
                      </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                          {suggestions.map((suggestion, index) => (
                            ...
                            >
                              ...
                              <div className="mt-4">
                                <h4 className="font-semibold group-hover:text-blue-600 transition-colors text-sm sm:text-base">
                                  {suggestion.title}
                                </h4>
                                <p className="text-gray-600 text-xs sm:text-sm mt-1">{suggestion.description}</p>
                                <div className="flex items-center justify-between mt-3">
                                  <div className="flex items-center">
                                    <Star className="h-3 w-3 sm:h-4 sm:w-4 text-yellow-400 fill-current" />
                                    <span className="text-xs sm:text-sm font-medium ml-1">{suggestion.rating}</span>
                                  </div>
                                  <span className="text-sm sm:text-lg font-bold text-blue-600">₹{suggestion.price}</span>
                                </div>
                              </div>
                            </motion.div>
                          ))}
                ...
                {activeTab === 'search' && (
                  <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border p-4 sm:p-6">
                      <h2 className="text-xl sm:text-2xl font-bold mb-4">Find Your Perfect Vehicle</h2>
                      ...
                      {vehicles.map((vehicle, index) => (
                        ...
                        >
                          ...
                          <div className="p-4 sm:p-6">
                            ...
                            <p className="text-gray-600 text-xs sm:text-sm mb-2">{vehicle.company}</p>
                            <p className="text-gray-600 text-xs sm:text-sm mb-4">{vehicle.category} • {vehicle.capacity} seats • {vehicle.location}</p>
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                              <span className="text-lg sm:text-2xl font-bold text-blue-600">₹{vehicle.price}/day</span>
                              <button
                                onClick={() => {
                                ...
                                className="w-full sm:w-auto bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors text-sm"
                              >
                          ...
                          <div className="flex flex-col lg:flex-row lg:items-start space-y-4 lg:space-y-0 lg:space-x-6">
                            ...
                            <div className="flex-1">
                              <div className="flex flex-col sm:flex-row justify-between items-start mb-4 gap-2">
                                <div>
                                  <h3 className="text-lg sm:text-xl font-semibold">{booking.vehicleName}</h3>
                                  <p className="text-gray-600">{booking.destination}</p>
                                </div>
                                <span className={`px-3 py-1 text-sm rounded-full self-start ${
                                  booking.status === 'Confirmed' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'
                                }`}>
                                  {booking.status}
                                </span>
                              ...
                              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                                <button className="flex items-center justify-center space-x-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm">
                                  <Phone className="h-4 w-4" />
                                  <span>Call Driver</span>
                                </button>
                                <button className="flex items-center justify-center space-x-2 px-4 py-2 text-gray-600 border border-gray-300 rounded-lg hover:bg-gray-50 text-sm">
                ...
                {activeTab === 'settings' && (
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                      {/* Profile Information */}
                      <div className="xl:col-span-2 bg-white rounded-xl shadow-sm border p-4 sm:p-6">
                ...
                {activeTab === 'enquiry' && (
                  <div className="space-y-6">
                    <h2 className="text-xl sm:text-2xl font-bold">Contact & Support</h2>
